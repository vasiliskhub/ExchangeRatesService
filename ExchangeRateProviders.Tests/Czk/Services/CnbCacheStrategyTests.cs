...
public class CnbCacheStrategyTests
{
    ...
    public void CacheDuration_WeekendVsWeekday_DifferentDurations()
    {
        ...
        Assert.That(durationMinutes, Is.EqualTo(1).Or.EqualTo(5).Or.EqualTo(60).Or.EqualTo(870),
            "Cache duration should be 5 minutes (publication window), 1 hour (weekday stable), or 12 hours (weekend)");
    }
